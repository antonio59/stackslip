...
- Add Receipt components and StackOverflow data hook with barcode generation
- Update dependencies and remove .bolt configuration files
- Add GitHub workflows and configuration files for security and dependency management
- Initial commit: Add project files downloaded from Netlify
